          ...
          >
            ...
            <ul className="space-y-2">
              {cat.skills.map((skill, i) => (
                <li
                  key={i}
                  className="inline-block bg-white/60 rounded-full px-4 py-2 shadow border border-transparent hover:border-rose-500 hover:text-rose-700 hover:bg-rose-100 hover:scale-105 transition-all duration-300 font-sans"
                >
                  {skill}
                </li>
              ))}
