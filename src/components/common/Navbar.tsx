        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              className="md:hidden fixed top-16 right-0 w-50 z-40 bg-pink-100 p-6 flex flex-col gap-6 text-rose-800 shadow-lg border-l border-b border-rose-600"
            >
              {[
                { href: "#about", label: "About", icon: faUser },
                { href: "#skills", label: "Skills", icon: faWrench },
                ...
                >
                  <FontAwesomeIcon icon={link.icon} />
                  <span className="relative left-3">{link.label}</span>
                </motion.a>
              ))}
            </motion.div>
          </>
