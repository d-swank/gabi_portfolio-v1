  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed top-0 right-0 left-0 z-50 bg-[var(--surface-nav)] backdrop-blur-lg"
      >
          ...
          <div className="flex h-18 items-center justify-between sm:h-20">
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <motion.button
                ...
                className="relative z-50 flex h-12 w-12 flex-col items-center justify-center gap-1.5 rounded-lg border border-rose-400/20 bg-[var(--surface-deep)] shadow-sm shadow-black/20 transition hover:bg-rose-400/10 md:hidden"
