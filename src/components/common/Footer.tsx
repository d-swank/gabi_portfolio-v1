...
export default function Footer() {
  return (
    <motion.footer
      ...
      viewport={{ once: true }}
      className="mt-12 w-full border-t border-[var(--subtle-border)] bg-[var(--surface-deep)] px-3 py-6 text-[var(--text-muted)] backdrop-blur-sm sm:px-5 lg:px-6"
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-5 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col gap-3 text-left md:items-end md:text-right">
          <p className="inline-flex items-center gap-1 text-sm font-semibold text-[var(--text-strong)]">
          ...
          <div className="flex items-center gap-4 text-xl md:justify-end">
            <a
              ...
              title="Next.js"
              aria-label="Next.js"
              className="text-[var(--text-soft)] transition hover:text-[var(--accent-text)]"
            >
              <SiNextdotjs />
            </a>
            <a
